...
export default function ProtectingYourFamilyPage() {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-[#d4a017]/10 border-l-4 border-[#d4a017] rounded-r-2xl p-5 mb-10">
        <p className="text-[#0a1628] font-semibold text-sm leading-relaxed">
          &ldquo;A plan without legal protection is just a hope. This course gives your family the real protection they deserve.&rdquo;
        </p>
      ...
      <div className="space-y-3 mb-10">
        {course.lessons.map((lesson, index) => (
          <Link
            key={lesson.id}
            href={`/dashboard/courses/protecting-your-family/lesson/${lesson.id}`}
      ...
      <Link
        href="/dashboard/courses/protecting-your-family/lesson/1"
