...
export default function BankingCreditFoundationsPage() {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-[#d4a017]/10 border-l-4 border-[#d4a017] rounded-r-2xl p-5 mb-10">
        <p className="text-[#0a1628] font-semibold text-sm leading-relaxed">
          &ldquo;Your credit score is not your character. But it does affect your opportunities. This course gives you the tools to take control.&rdquo;
        </p>
      ...
      <div className="space-y-3 mb-10">
        {course.lessons.map((lesson, index) => (
          <Link
            key={lesson.id}
            href={`/dashboard/courses/banking-credit-foundations/lesson/${lesson.id}`}
      ...
      <Link
        href="/dashboard/courses/banking-credit-foundations/lesson/1"
