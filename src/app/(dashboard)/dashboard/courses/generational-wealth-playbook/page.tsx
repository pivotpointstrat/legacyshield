...
export default function GenerationalWealthPlaybookPage() {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-10">
        ...
        <div className="flex flex-wrap items-center gap-4 text-sm text-gray-400">
          ...
          <span className="bg-yellow-100 text-yellow-700 text-xs font-semibold px-3 py-1 rounded-full">{course.level}</span>
        </div>
      </div>
      ...
      <div className="bg-[#d4a017]/10 border-l-4 border-[#d4a017] rounded-r-2xl p-5 mb-10">
        <p className="text-[#0a1628] font-semibold text-sm leading-relaxed">
          &ldquo;I spent 30 years watching what happens to families who weren&apos;t prepared. This course is everything I wish someone had handed them before it was too late.&rdquo;
        </p>
      ...
      <div className="space-y-3 mb-10">
        {course.lessons.map((lesson, index) => (
          <Link
            key={lesson.id}
            href={`/dashboard/courses/generational-wealth-playbook/lesson/${lesson.id}`}
      ...
      <Link
        href="/dashboard/courses/generational-wealth-playbook/lesson/1"
