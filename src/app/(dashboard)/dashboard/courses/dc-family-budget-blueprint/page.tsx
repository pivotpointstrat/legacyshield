...
export default function DCFamilyBudgetBlueprintPage() {
  return (
    <div className="max-w-3xl mx-auto">
      ...
      <div className="bg-[#d4a017]/10 border-l-4 border-[#d4a017] rounded-r-2xl p-5 mb-10">
        <p className="text-[#0a1628] font-semibold text-sm leading-relaxed">
          &ldquo;Generic budget advice was not built for DC families. This blueprint was. Real numbers, real strategies, for where you actually live.&rdquo;
        </p>
      ...
      <div className="space-y-3 mb-10">
        {course.lessons.map((lesson, index) => (
          <Link
            key={lesson.id}
            href={`/dashboard/courses/dc-family-budget-blueprint/lesson/${lesson.id}`}
      ...
      <Link
        href="/dashboard/courses/dc-family-budget-blueprint/lesson/1"
